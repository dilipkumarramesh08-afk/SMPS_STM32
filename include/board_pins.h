 ...
 *
 * TIM1 drives the primary bridge, and PA0 is optocoupler feedback.
...
#define PIN_VOUT_FB_PIN            0u      /* PA0 ADC1_IN0 opto feedback */

#define PIN_FAULT_LED_PORT         GPIOC
#define PIN_FAULT_LED_PIN          13u     /* PC13 fault LED */
